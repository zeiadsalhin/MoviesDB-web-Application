<template>
    <div class="main mt-12">
        <div class="main px-5 text-2xl mt- -mb-5 flex">
            <h1 class="my-auto">Top History Movies </h1>
            <router-link :to="{ name: 'genre', params: { id: 36, name: 'Top History Movies' } }"
...
export default {
    ...
    methods: {
        async fetchMovies() {
            ...
            try {
                const response = await fetch(`https://api.themoviedb.org/3/discover/movie?&page=${this.currentPage}&with_genres=36`, options);
