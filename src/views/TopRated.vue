    ...
    <transition name="fade" mode="out-in">
        <div class="main mt-20">
            <div class=" w-11/12 mx-auto p-2">
                <h1 class="text-2xl">{{ $route.params.name }}
                </h1>
            </div>
            <div v-if="results" class="movie-list flex justify-center" ref="movieList">
                <div class="movie-row p-1">
                    ...
                    result.vote_average.toFixed(1)
                                ...
                                <p v-if="result.title" class="opacity-70 text-sm">Released<br> {{ result.release_date }}
                                </p>
    ...
    methods: {
        ...
        async loadMoreResults() {
            ...
            try {
                ...
                const url = `https://api.themoviedb.org/3/${this.$route.params.id}/top_rated?language=en-US&page=${this.currentPage}`;
